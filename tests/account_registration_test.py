from DexilonAccountClient import DexilonAccountClient
...
class TestAccountRegistration:
    ...
    def setup(self):
        ...
        self.test_instance = DexilonAccountClient()
    ...
    def test_should_get_cosmos_address_signed(self):
        result = self.test_instance.getSignature(self.test_instance.generate_random_eth_wallet(), 'cosmos14m8eeep93z6ka5exp2ccazem7nyq8v77w23r6f')
    ...
    def test_should_withdraw_funds_successfully(self):
        ...
        assert dexilon_withdraw_response is True